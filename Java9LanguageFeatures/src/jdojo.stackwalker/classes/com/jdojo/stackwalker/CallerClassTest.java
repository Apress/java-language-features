...
public class CallerClassTest {
    public static void main(String[] args) {
        // Will not be able to get caller class because the RETAIN_CLASS_REFERENCE 
        // option is not set./
        m1(Set.of());
        ...
        try {
            // The following statement will throw an IllegalStateException if this class 
            // is run. If the main() method is called in code, no exception will be thrown.         
